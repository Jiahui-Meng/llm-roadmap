# Day13 Model Families

## Summary
BERT vs GPT vs T5 model families, comparing encoder-only, decoder-only, and encoder-decoder designs, with practical trade-offs and use cases.
